...
namespace March_Game_Jam.GameStates
{
    public class FightScene : GameState
    {
        ...
        public FightScene() : base()
        {
            ...
            dad = new Dad(Game1.screen_width / 3, Game1.screen_height / 3);
            child = new Child(2 * Game1.screen_width / 3, Game1.screen_height / 3);
            void Test() {
        ...
        public bool dad_stat_check(Dictionary<dynamic,dynamic> a_dict, Dad dad){
        ...
        public bool child_stat_check(Dictionary<dynamic,dynamic> a_dict,Child child){
            bool current_returnable = true;
        ...
        public bool round_check(Dictionary<dynamic,dynamic> a_dict){
        ...
        public bool age_check(Dictionary<dynamic,dynamic> a_dict,Child child){
            bool current_returnable = true;
        ...
        public bool dad_flag_pass_check(Dictionary<dynamic,dynamic> a_dict,Dad dad){
        ...
        public bool dad_flag_block_check(Dictionary<dynamic,dynamic> a_dict,Dad dad){
        ...
        public bool child_flag_pass_check(Dictionary<dynamic,dynamic> a_dict,Child child){
        ...
        public bool child_flag_block_check(Dictionary<dynamic,dynamic> a_dict,Child child){
